...
#define SQL_DELETE_GROUP_MEMBERS "DELETE FROM group_members WHERE group_id = ?"
#define SQL_DELETE_MESSAGES      "DELETE FROM messages WHERE group_id = ?"
#define SQL_DELETE_GROUP_ONLY    "DELETE FROM `groups` WHERE group_id = ?"
